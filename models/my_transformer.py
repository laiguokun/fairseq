...
@register_model_architecture('my_transformer', 'my_transformer_vaswani_wmt_en_de_big')
...
@register_model_architecture('my_transformer', 'my_transformer_wmt_en_de_big')
